...
namespace PlayerList.Entries
{
    ...
    public class LocalPlayerEntry : PlayerEntry
    {
        ...
        public override void Init(object[] parameters)
        {
            ...
            perf = perf = player.prop_VRCPlayer_0.field_Private_VRCAvatarManager_0.prop_AvatarPerformanceStats_0.GetPerformanceRatingForCategory(AvatarPerformanceCategory.Overall);
